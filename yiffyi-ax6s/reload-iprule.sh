...
ip rule add from all table 1000 pref 33000

ip -6 rule add from all table main suppress_prefixlength 0 pref 30000
ip -6 rule add to 2001:250:6413::/48 table main pref 30010
ip -6 rule add to 240c:c7b9:0:400::/64 table main pref 30010
